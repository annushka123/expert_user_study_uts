...
class Swarm {
  ...
  float smoothingFactor = 0.2;  // Adjust this for smoother (0.1) or snappier (0.4) response
  ...
  void updateSpeed(float bSpeed) {
    ...
    smoothedSpeed = lerp(smoothedSpeed, bSpeed, smoothingFactor);
    ...
    // For debugging:
    println("Raw: " + bSpeed + " → Smoothed: " + smoothedSpeed);
  }
